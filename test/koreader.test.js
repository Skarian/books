...
test("KOReader starter bundles include account settings and SimpleUI paths", () => {
  ...
  assert.match(resumeHome, /return 3, 0\.85, 0, 3, Screen:scaleBySize\(18\)/);
  assert.match(resumeHome, /return 6, 1\.4, 0, 3, Screen:scaleBySize\(48\)/);
  ...
  assert.match(resumeHome, /d\.RECENT_W \+ Screen:scaleBySize\(48\)/);
