...
Start with the generated fixture:
...
|---|---|---|---|---|---|
| Books Sync Fixture | generated by `bin/books-sync-fixture` | repo-generated test file |  |  | Use `docs/real-device-sync-test.md` first |
| 2 |  |  |  |  |  |
| 3 |  |  |  |  |  |
